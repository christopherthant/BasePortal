...
namespace Teromac.Web.Framework
{
    public static class HtmlExtensions
    {
        ...
        public static MvcHtmlString DeleteConfirmation<T>(this HtmlHelper<T> helper, string buttonsSelector) where T : BaseTeromacEntityModel
        {
        ...
        public static MvcHtmlString DeleteConfirmation<T>(this HtmlHelper<T> helper, string actionName,
            string buttonsSelector) where T : BaseTeromacEntityModel
        {
        ...
        public static string GetSelectedTabName(this HtmlHelper helper)
        {
            ...
            const string dataKey = "twf.selected-tab-name";
        ...
        //public static MvcHtmlString TeromacLabelFor<TModel, TValue>(this HtmlHelper<TModel> helper,
        ...
        //    if (metadata.AdditionalValues.TryGetValue("TeromacResourceDisplayName", out value))
        //    {
        //        var resourceDisplayName = value as TeromacResourceDisplayName;
        ...
        public static MvcHtmlString TeromacEditorFor<TModel, TValue>(this HtmlHelper<TModel> helper,
        ...
        public static MvcHtmlString TeromacDropDownList<TModel>(this HtmlHelper<TModel> helper, string name,
        ...
        public static MvcHtmlString TeromacDropDownListFor<TModel, TValue>(this HtmlHelper<TModel> helper,
        ...
        public static MvcHtmlString TeromacTextAreaFor<TModel, TValue>(this HtmlHelper<TModel> helper,
        ...
        public static MvcHtmlString TeromacDisplayFor<TModel, TValue>(this HtmlHelper<TModel> helper, Expression<Func<TModel, TValue>> expression)
        {
        ...
        public static MvcHtmlString TeromacDisplay<TModel>(this HtmlHelper<TModel> helper, string expression)
        {
            var result = new TagBuilder("div");
            result.Attributes.Add("class", "form-text-row");
