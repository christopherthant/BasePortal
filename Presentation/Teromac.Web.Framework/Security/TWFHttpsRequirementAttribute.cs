...
namespace Teromac.Web.Framework.Security
{
    [AttributeUsage(AttributeTargets.Class | AttributeTargets.Method, Inherited = true, AllowMultiple = false)]
    public class TeromacHttpsRequirementAttribute : FilterAttribute, IAuthorizationFilter
    {
        public TeromacHttpsRequirementAttribute(SslRequirement sslRequirement)
        {
        ...
        public virtual void OnAuthorization(AuthorizationContext filterContext)
        {
            ...
            switch (this.SslRequirement)
            {
                ...
                case SslRequirement.NoMatter:
                    ...
                    break;
                default:
                    throw new TeromacException("Not supported SslProtected parameter");
            }
        }
