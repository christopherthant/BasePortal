...
namespace Teromac.Web.Framework.Validators
{
    public abstract class BaseTeromacValidator<T> : AbstractValidator<T> where T : class
    {
        protected BaseTeromacValidator()
        {
            PostInitialize();
        }
