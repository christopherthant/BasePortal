...
{
    //[TeromacHttpsRequirement(SslRequirement.Yes)]
    [RegisteredAuthorize]
    [AdminAntiForgery]
    public abstract partial class BasePrivateController : BaseController
    {
        /// <summary>
        ...
        protected void SaveSelectedTabName(string tabName = "", bool persistForTheNextRequest = true)
        {
            ...
            //"GetSelectedTabName" method of \Teromac.Web.Framework\HtmlExtensions.cs
