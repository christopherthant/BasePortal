...
using Teromac.Core.Domain.Forums;
...
namespace Teromac.Services.Tests.Customers
{
    [TestFixture]
    public class CustomerRegistrationServiceTests : ServiceTest
    {
        ...
        public new void SetUp()
        {
            ...
            _customerService = new CustomerService(new TeromacNullCache(), _customerRepo, _customerRoleRepo,
