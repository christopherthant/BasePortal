...
using Teromac.Web.Infrastructure.Installation;
using Teromac.Web.Models.Install;
using Teromac.Web.Validators.Install;
using NUnit.Framework;
using Rhino.Mocks;

namespace Teromac.Web.MVC.Tests.Public.Validators.Install
{
    [TestFixture]
