...
namespace Teromac.Services.Security
{
    public class EncryptionService : IEncryptionService
    {
        ...
        public virtual string CreatePasswordHash(string password, string saltkey, string passwordFormat = "SHA2")
        {
        ...
        public virtual string CreateHash(byte[] data, string hashAlgorithm = "SHA2")
        {
