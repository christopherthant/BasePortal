...
namespace Teromac.Services.Directory
{
    /// <summary>
    ...
    public partial class StateProvinceService : IStateProvinceService
    {
        ...
        /// </remarks>
        private const string STATEPROVINCES_ALL_KEY = "Teromac.stateprovince.all-{0}-{1}-{2}";
        /// <summary>
        /// Key pattern to clear cache
        /// </summary>
        private const string STATEPROVINCES_PATTERN_KEY = "Teromac.stateprovince.";
